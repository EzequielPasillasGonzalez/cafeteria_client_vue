    ...
    <div class="three_quarter">
      <ul class="nospace clear">
        <li class="one_third first">
          <div class="block clear"><a href="#"><i class="fas fa-phone"></i></a> <span><strong>Marcanos:</strong> +00 (123) 456 7890</span></div>
        </li>
        <li class="one_third">
  ...
  <main class="hoc container clear"> 
    ...
    <div class="group center btmspace-80">
      ...
      <article class="one_third"><a class="ringcon btmspace-50" href="#"><i class="fas fa-paw"></i></a>
        <h6 class="heading">Integer molestie sapien ac</h6>images/demo/
...
input:focus, textarea:focus, *:required:focus{border-color:#1d6042;}
...
.btn, .btn.inverse:hover{color:#FFFFFF; background-color:#1d6042; border-color:#1d6042;}
.btn:hover, .btn.inverse{color:inherit; background-color:transparent; border-color:inherit;}

.imgover:hover::before{background:rgba(0,0,0,.55);}
.imgover, .imgover:hover::after{color:#1d6042;}


/* Rows */
.row0{color:#474747; background-color:#F4F4F4;}
.row1, .row1 a{color:#FFFFFF; background-color:#1d6042;}
...
#header #logo h1::after{background-color:#1d6042;}
#header #logo h1 a{color:inherit;}
#header #logo h1 span{color:#1d6042;}


/* Search Form */
#searchform{color:rgba(255,255,255,.5); background:#AA5670;}
#searchform:hover{color:#1d6042;}
...
#footer input:focus{border-color:#1d6042;}
#footer button{color:#FFFFFF; background-color:#1d6042;}
...
#mainav li li a, #mainav .active li a{color:#FFFFFF; background-color:rgba(149,16,59,.5);/* #1d6042 */ border-color:rgba(0,0,0,.6);}
#mainav li li:hover > a, #mainav .active .active > a{color:#D5ACBB; background-color:#1d6042;}
#mainav form select{color:#474747; background-color:#FFFFFF;}

#breadcrumb a{color:inherit; background-color:inherit;}
#breadcrumb li:last-child a{color:#1d6042;}

.container .sidebar nav a{color:inherit; border-color:#D7D7D7;}
.container .sidebar nav a:hover{color:#1d6042;}

.pagination a, .pagination strong{border-color:#D7D7D7;}
.pagination .current *{color:#FFFFFF; background-color:#1d6042;}

#backtotop{color:#FFFFFF; background-color:#1d6042;}


/* Tables + Comments */
table, th, td, #comments .avatar, #comments input, #comments textarea{border-color:#D7D7D7;}
#comments input:focus, #comments textarea:focus, #comments *:required:focus{border-color:#1d6042;}
